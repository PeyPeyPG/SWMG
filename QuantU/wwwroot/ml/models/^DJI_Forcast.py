...
def main():
    ...
    df.to_csv('/Users/antoinesfeir/Documents/GitHub/SWMG/QuantU/wwwroot/ml/^DJI_StockPrices.csv')
    ...
    with open('/Users/antoinesfeir/Documents/GitHub/SWMG/QuantU/wwwroot/ml/^DJI_Forcast.csv', 'w', newline='') as file:
      writer = csv.writer(file)
      writer.writerows(data)

# Scheduling the script to run every day at 1:30 AM
schedule.every().day.at("1:30").do(main)
